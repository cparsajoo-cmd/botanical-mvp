...
if __name__=='__main__':
    rows,metrics=evaluate(); payload={'version':'decision-holdout-v4/1.0.0','rows':rows,'metrics':asdict(metrics)}; (BASE/'results.json').write_text(json.dumps(payload,indent=2,default=str)); print(json.dumps(payload,indent=2,default=str))

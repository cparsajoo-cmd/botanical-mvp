...
BASE=ROOT/'gold_corpus'/'decision_holdout_v3'
...
if __name__=='__main__':
    ...
    payload={'version':'decision-holdout-v3/1.0.0','engine_version':DECISION_ENGINE_VERSION,'rows':rows,'metrics':metrics_dict}
    ...
    artifact,registry,_=persist_validation_run(
        repo_root=ROOT, dataset_name='decision_holdout_v3', dataset_version='1.0.0',
        ...
        safety_regulatory_metrics=high_risk, historical_blind_result_path='gold_corpus/decision_holdout_v3/results.json',

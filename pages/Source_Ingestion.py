...
with st.form("source_ingestion_form"):
    ...
    submitted = st.form_submit_button("Create structured evidence record")
...
if submitted:
    ...
    st.success("Structured evidence record created.")
    ...
    st.download_button(
        label="Download new evidence record as CSV",
        data=csv,
        file_name="new_evidence_record.csv",
        mime="text/csv"
      )

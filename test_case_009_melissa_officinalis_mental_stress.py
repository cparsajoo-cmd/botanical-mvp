"""Focused regression tests for corrected Case 009."""
...
from gold_case_reference_grounded_009_melissa_officinalis_mental_stress import build_gold_case_refgrounded_009_melissa_officinalis_mental_stress

def _case():
    return build_gold_case_refgrounded_009_melissa_officinalis_mental_stress()
...
def test_outcome_selected():
    ...
    assert outcome.selected_reference_id == 'EMA_HMPC_310761_2013_melissae_folium_summary'

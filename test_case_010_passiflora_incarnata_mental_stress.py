"""Focused regression tests for corrected Case 010."""
...
from gold_case_reference_grounded_010_passiflora_incarnata_mental_stress import build_gold_case_refgrounded_010_passiflora_incarnata_mental_stress

def _case():
    return build_gold_case_refgrounded_010_passiflora_incarnata_mental_stress()
...
def test_outcome_selected():
    ...
    assert outcome.selected_reference_id == 'EMA_275240_2014_passiflorae_herba_summary'
